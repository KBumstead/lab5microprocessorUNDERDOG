...
void setBuzzerFrequency(uint16_t frequency)
{
    ...
    uint16_t topValue = (16000000 / (8 * frequency)) - 1; //top value is frequency
    ICR3 = topValue;
    OCR3A = topValue / 2;
}
...
void buzzerChirp()
{
    //How to produce the chirping soundeffect

    // Chirp: Sweep frequency from 1000 Hz to 5000 Hz and back down
    ...
    // Chirp: Sweep frequency from 5000 Hz to 1000 Hz
